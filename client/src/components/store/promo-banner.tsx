    ...
    <div className="px-4 mb-6">
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-transparent flex flex-col justify-center p-6 text-white">
          <span className="text-xs font-bold tracking-wider uppercase mb-2 bg-white/20 backdrop-blur-md w-fit px-4 py-1 rounded-lg">New Drop</span>
          <h2 className="text-2xl font-bold mb-1">Nike Air Max</h2>
          <p className="text-sm opacity-90 mb-4">Future of comfort</p>
          <button className="w-fit bg-white text-black px-4 py-2 rounded-full text-xs font-bold hover:bg-gray-100 transition-colors">
            Shop Now
          </button>
        </div>
      </motion.div>
