              ...
              {(() => {
                ...
                return activeDiscount ? (
                  <motion.div 
                    ...
                    <div className="relative bg-gradient-to-br from-red-500 via-red-600 to-red-700 text-white px-4 py-3 rounded-full text-2xl font-black shadow-2xl shadow-red-600/60 border-2 border-yellow-300 flex items-center gap-1">
