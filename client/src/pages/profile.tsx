...
export default function ProfilePage() {
  ...
  const { user, isLoggedIn, logout, isLoading, setRole } = useUser();
              ...
              <div className="w-full px-6 py-4 space-y-3">
                ...
                {user?.role !== "admin" && (
                  <button
                    ...
                    className="w-full flex items-center justify-between p-4 bg-blue-50 rounded-2xl border border-blue-100 hover:border-blue-200 transition-colors group"
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <span className="font-semibold text-sm text-blue-600">Become Admin</span>
                    </div>
